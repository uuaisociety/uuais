...
export default function VoteButton({
  ...
  return (
    <button
      ...
      aria-pressed={voted}
      className={`group/vote inline-flex min-h-11 cursor-pointer items-center gap-1.5 rounded-md border px-3 transition-colors duration-300 disabled:cursor-wait disabled:opacity-60 ${
        voted
