...
// import { incrementEventUniqueClick, registerForEvent } from '@/lib/firestore';
...
//     try {
//       // Use centralized helper to create a registration document
...
//   const loading = state.isLoading && events.length === 0;
...
//                     <p className="text-white/80 line-clamp-3">{event.description}</p>
//                   </div>
