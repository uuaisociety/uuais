...
- **Web search access**: Required for researching target companies
- **Optional**: Codebase analysis for understanding your product
- **Optional**: Google/LinkedIn search tools for company research
